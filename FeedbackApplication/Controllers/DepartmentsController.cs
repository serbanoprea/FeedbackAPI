...
namespace FeedbackApplication.Controllers
{
    ...
    public class DepartmentsController : ControllerBase
    {
        ...
        [HttpGet("ByName/{name}")]
        public async Task<ActionResult<Departments>> GetDepartmentsByName(string name)
        {
            var departments = await _context.Departments.SingleOrDefaultAsync(d => d.DepartmentName.ToLower() == name.ToLower());
